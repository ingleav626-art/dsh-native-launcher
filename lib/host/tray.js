...
function writeTrayScript(launcherDir, port, iconPath, openScriptPath, appId) {
  ...
  exit 0
    ...
    `reg add 'HKCU\\Software\\Classes\\AppUserModelId\\DshNativeLauncher' /v IconUri /d '${join2(launcherDir, "dsh-webui.ico").replace(/'/g, "''")}' /f | Out-Null`,
